...
I enjoy turning raw information into clear insights through data analysis, dashboards and economic interpretation. I work with tools like **R, Python, Excel and Power BI**, and I am currently building stronger foundations in quantitative analysis, visualization and decision support.

---

## 🔧 What I Do Best

- 📈 **Economic & Data Analysis** - Working with data to understand trends, patterns and indicators.
- 📊 **Dashboards & Visualization** - Creating clearer ways to communicate information with Excel and Power BI.
- 🧮 **Quantitative Thinking** - Applying statistical and analytical reasoning to economic problems.
- 💻 **Programming Basics** - Using R, Python and C to explore data and solve problems.
- 🚀 **Digital Markets Research** - Interested in financial markets, virtual economies and innovation.
...
- [`Data Visualization for Decision-Making`](#)  
  Course-based work using Excel and Power BI to transform information into dashboards, metrics and decision-support visuals.
...
- 🎓 **BSc in Economics** - University of Beira Interior, 2023-present
- 📊 **Decision-Making with Data Visualization** - Excel, Power BI, dashboards and indicators
- 🛡️ **Occupational Health and Risk Prevention** - productivity, prevention and workplace organization

---

## 🤝 I'm Open To

- Collaborating on academic or data-analysis projects
- Building dashboards and simple analytical tools
- Learning opportunities in economics, data and financial markets
- Exploring projects related to digital economies and technology
...
> "Turning data into decisions, and curiosity into progress."
